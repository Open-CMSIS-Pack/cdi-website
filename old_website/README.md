# open-cmsis-cdi.org Static Jekyll Site

This is the git repository for the open-cmsis-cdi.org static Jekyll-based website.

Hosted in this repo are the markdown content files associated with the website. Feel free to [submit a PR](https://github.com/Open-CMSIS-Pack/cdi-website/pulls) / [Issue](https://github.com/Open-CMSIS-Pack/cdi-website/issues/new) if there is anything you would like to change.
...
The built web site directory will be `production.open-cmsis-cdi.org`.
